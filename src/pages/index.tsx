...
const WebGLShader = () => {
    ...
    <div className='grid place-items-center h-screen'>
        <canvas ref={canvasRef} className='w-full h-full col-start-1 row-start-1' />
        <div className='col-start-1 row-start-1 rounded-md bg-gradient-to-t from-slate-300 to-slate-100'>
            <h1 className='text-5xl mx-10'>Welcome to my Portfolio!</h1>
        </div>
    </div>
    );
}
